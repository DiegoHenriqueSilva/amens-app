...
const REPORT_CATEGORIES = [
  ...
  { value: "spam", label: "Spam ou mensagem repetida" },
...
export const ReportMessageDialog = ({ open, targetUserId, senderName, onClose, onConfirmed }: Props) => {
            ...
            <div className="bg-white rounded-[2rem] shadow-2xl border border-red-100 p-6">
              <div className="flex items-center justify-between mb-5">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h3 className="text-base font-bold text-foreground">Reportar Mensagem</h3>
                    {senderName && <p className="text-[10px] text-muted-foreground">de {senderName}</p>}
                  </div>
                </div>
